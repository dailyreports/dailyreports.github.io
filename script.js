function generateReport() {
    ...
    const reportTemplate = `Hello! Today ${childName} worked on ${skillsWorkedOn}. They made lots of progress on ${skillsMastered} and we will continue to help ${childName} get a better understanding of ${skillsToPractice}. Please let us know if you have any questions!`;
